...
class TrustContractClient:
    """A class for interacting with the trust_contract app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        TrustContractClient can be created with an app_id to interact with an existing application, alternatively
